...
# Adapted from
# https://github.com/huggingface/transformers/blob/main/src/transformers/models/olmo2_retrofit/modeling_olmo2_retrofit.py
...
"""Inference-only OLMo2 Retrofit model compatible with HuggingFace weights."""
...
class Olmo2RetrofitAttention(nn.Module):
    """
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        assert isinstance(self.config, Olmo2RetrofitConfig)
...
class Olmo2RetrofitMLP(nn.Module):
    """
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        assert isinstance(config, Olmo2RetrofitConfig)
...
class Olmo2RetrofitDecoderLayer(nn.Module):
    """
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        assert isinstance(config, Olmo2RetrofitConfig)
        # Attention block.
        self.self_attn = Olmo2RetrofitAttention(vllm_config=vllm_config,
                                                prefix=f"{prefix}.self_attn")

        # MLP block.
        self.mlp = Olmo2RetrofitMLP(vllm_config=vllm_config,
                                    prefix=f"{prefix}.mlp")
...
class Olmo2RetrofitModel(nn.Module):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: Olmo2RetrofitDecoderLayer(vllm_config=vllm_config,
                                                     prefix=prefix),
...
class Olmo2RetrofitForCausalLM(nn.Module, SupportsPP):
    """
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        assert isinstance(config, Olmo2RetrofitConfig)
        self.config = config
        self.model = Olmo2RetrofitModel(vllm_config=vllm_config,
